...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1038413990, 0);
});

//generic boss event
$Event(1038413990, Default, function() {
    WaitFor(CharacterDead(1038410800));
    //boss rewards (4 bonus items)
    InitializeCommonEvent(0,90001024,1049304144,1049304043,1049304047,-1,1049304706,1049304598,1049304599,1049304600,1049304601,1049304708,1049304710,1049304713,1049304716,1049300144);
});
