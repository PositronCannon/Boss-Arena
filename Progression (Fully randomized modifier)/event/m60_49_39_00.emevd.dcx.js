...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1049399990, 0);
});

//generic boss event
$Event(1049399990, Default, function() {
    WaitFor(CharacterDead(1049390850));
...
$Event(1049390800, Restart, function() {
    ...
    InitializeCommonEvent(0,90001023,1049304153,1049304058,-1,-1,1049304806,1049304636,1049304637,1049304638,1049304809,1049304811,1049304816,1049300153);
