...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1044322990, 0);
    //init boss reward
    InitializeEvent(0, 1044322991, 0);
});

//deathbird
$Event(1044322990, Default, function() {
    WaitFor(CharacterDead(1044320340));
    //boss reward (4 bonus items)
    InitializeCommonEvent(0,90001024,1049304123,1049304034,1049304032,-1,1049304441,1049304500,1049304501,1049304502,1049304503,1049304444,1049304446,1049304448,1049304450,1049300123);
});

//night's cavalry
$Event(1044322991, Default, function() {
    WaitFor(CharacterDead(1044320342));
    //boss rewards (3 bonus items)
    InitializeCommonEvent(0,90001023,1049304125,1049304032,1049304034,-1,1049304465,1049304509,1049304510,1049304511,1049304468,1049304470,1049304472,1049300125);
});
