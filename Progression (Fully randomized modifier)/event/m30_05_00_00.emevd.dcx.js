...
$Event(0, Default, function() {
    InitializeCommonEvent(0, 90005646, 30050800, 30052840, 30052841, 30051840, 30052840, 1310);
    InitializeCommonEvent(0, 90005646, 30050850, 30052890, 30052891, 30051890, 30052840, 1310);
    RegisterBonfire(300500, 30051950, 0, 0, 0, 5);
    InitializeEvent(0, 30052880, 0);
    InitializeEvent(0, 30052800, 0);
    InitializeEvent(0, 30052810, 0);
    InitializeEvent(0, 30052849, 0);
    InitializeEvent(0, 30052811, 0);
    InitializeEvent(0, 30052850, 0);
    InitializeEvent(0, 30052860, 0);
    InitializeEvent(0, 30052899, 0);
    InitializeEvent(0, 30052861, 0);
...
$Event(50, Default, function() {
    ...
    InitializeCommonEvent(0, 90005200, 30050815, 30003, 20003, 30052800, 1050253722, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050816, 30003, 20003, 30052800, 1058642330, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050817, 30003, 20003, 30052800, 1067030938, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050200, 30003, 20003, 30052200, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050202, 30003, 20003, 30052202, 1065353216, 0, 0, 0, 0);
    InitializeEvent(0, 30052203, 30050203);
    InitializeCommonEvent(0, 90005200, 30050203, 30003, 20003, 30052202, 1071225242, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050201, 30003, 20003, 30052302, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050204, 30003, 20003, 30052302, 1083179008, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050205, 30003, 20003, 30052205, 1077936128, 0, 0, 0, 0);
    ...
    InitializeCommonEvent(0, 90005211, 30050208, 30003, 20003, 30052208, 1092616192, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050209, 30003, 20003, 30052209, 1077936128, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050210, 30003, 20003, 30052209, 1077936128, 0, 0, 0, 0);
    ...
    InitializeCommonEvent(0, 90005200, 30050213, 30003, 20003, 30052213, 1082130432, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30050214, 30003, 20003, 30052214, 1091567616, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005261, 30050300, 30052450, 1088421888, 0, 0);
    InitializeEvent(0, 30052302, 0);
    ...
    InitializeEvent(0, 30052450, 30050451, 30001, 20001, 30052450, 1090519040, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005780, 30050850, 30052160, 30052161, 30050700, 20, 30052711, 11109649, 1, 0);
...
$Event(30052203, Restart, function(X0_4) {
    EndIf(ThisEventSlot());
    SetSpEffect(X0_4, 17210);
    SetNetworkconnectedThisEventSlot(ON);
});

$Event(30052300, Restart, function(X0_4, X4_4) {
    EndIf(ThisEventSlot());
    WaitFor(CharacterHasSpEffect(X0_4, 14716));
    SetSpEffect(X4_4, 14717);
    SetNetworkconnectedThisEventSlot(ON);
});
...
$Event(30052350, Restart, function(X0_4, X4_4) {
    EndIf(ThisEventSlot());
    WaitFor(
        CharacterDead(X0_4)
            && CharacterHasSpEffect(X4_4, 14717)
            && (!CharacterHasSpEffect(X4_4, 5080) || !CharacterHasSpEffect(X4_4, 5450)));
    WaitFixedTimeSeconds(0.8);
    ClearSpEffect(X4_4, 5860);
...
$Event(30052400, Default, function() {
    if (EventFlag(57)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202070, 1082130432, 0);
    }
    if (EventFlag(56)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202060, 1082130432, 0);
    }
    if (EventFlag(55)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202050, 1082130432, 0);
    }
    if (EventFlag(54)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202040, 1082130432, 0);
    }
    if (EventFlag(53)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202030, 1082130432, 0);
    }
    if (EventFlag(52)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202020, 1082130432, 0);
    }
    if (EventFlag(51)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202010, 1082130432, 0);
    }
    if (EventFlag(50)) {
        InitializeCommonEvent(0, 90005675, 30052650, 30053500, 30051500, 30052650, 801202000, 1082130432, 0);
    }
    if (EventFlag(57)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202070, 1073741824, 0);
    }
    if (EventFlag(56)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202060, 1073741824, 0);
    }
    if (EventFlag(55)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202050, 1073741824, 0);
    }
    if (EventFlag(54)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202040, 1073741824, 0);
    }
    if (EventFlag(53)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202030, 1073741824, 0);
    }
    if (EventFlag(52)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202020, 1073741824, 0);
    }
    if (EventFlag(51)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202010, 1073741824, 0);
    }
    if (EventFlag(50)) {
        InitializeCommonEvent(0, 90005675, 30052702, 30053502, 30051502, 30052650, 801202000, 1073741824, 0);
    }
    if (EventFlag(57)) {
...
$Event(30052450, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4) {
    ...
    chrSp = (CharacterType(10000, TargetType.BlackPhantom) && CharacterHasSpEffect(10000, 3710))
        ...
        || CharacterType(10000, TargetType.WhitePhantom);
    areaChrSp &= (InArea(10000, X12_4) || InArea(10000, 30052451))
...
$Event(30052800, Restart, function() {
    ...
    InitializeCommonEvent(0,90001023,1049304134,1049304047,-1,1049304004,1049304575,1049304551,1049304552,1049304553,1049304577,1049304580,1049304584,1049300134);
...
$Event(30052850, Restart, function() {
    ...
    InitializeCommonEvent(0,90001024,1049304132,1049304043,1049304047,-1,1049304547,1049304541,1049304542,1049304543,1049304544,1049304549,1049304552,1049304557,1049304559,1049300132);
    WaitFixedTimeSeconds(6);
    WarpPlayer(11, 10, 0, 0, 11102021, -11100);
});
...
$Event(30052825, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
...
$Event(30052870, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4) {
    if (!EventFlag(X0_4)) {
