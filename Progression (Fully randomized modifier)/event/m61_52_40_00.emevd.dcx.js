...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 2052409990, 0);
});

//generic boss event
$Event(2052409990, Default, function() {
    WaitFor(CharacterDead(2052400800));
    //boss rewards (3 bonus items, DLC version)
    InitializeCommonEvent(0,90001043,1049304299,1049304154,-1,1049307301,1049307302,1049307303,1049307304,1049306580,1049306582,1049306585,1049306587,1049300299);
});
