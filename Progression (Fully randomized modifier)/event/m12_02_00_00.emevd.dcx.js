...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 12029990, 0);
});

//dragonkin soldier
$Event(12029990, Default, function() {
    WaitFor(CharacterDead(12020830));
    //boss rewards (3 bonus items + guaranteed flag)
    InitializeCommonEvent(0,90001033,1049304208,1049304085,-1,-1,1049304887,1049304888,1049304889,1049304890,1049305477,1049305480,1049305482,1049305484,1049300208);
});
...
$Event(12022850, Restart, function() {
    ...
    InitializeCommonEvent(0,90001034,1049304196,1049304099,-1,-1,1049304835,1049304836,1049304837,1049304838,1049304839,1049305335,1049305337,1049305342,1049305345,1049305347,1049300196);
...
$Event(12022800, Restart, function() {
    ...
    //boss rewards (3 bonus items + guaranteed flag)
    InitializeCommonEvent(0,90001033,1049304214,1049304110,-1,-1,1049304911,1049304912,1049304913,1049304914,1049305540,1049305542,1049305544,1049305549,1049300214);
    WaitFixedTimeSeconds(6);
    WarpPlayer(11, 10, 0, 0, 11102021, 0);
});
