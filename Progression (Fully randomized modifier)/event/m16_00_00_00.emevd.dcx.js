...
$Event(16002800, Restart, function() {
    ...
    InitializeCommonEvent(0,90001033,1049304231,-1,-1,1049304004,1049304988,1049304989,1049304990,1049304991,1049305741,1049305745,1049305747,1049305749,1049300231);
...
$Event(16002850, Restart, function() {
    ...
    //boss rewards (3 bonus items + guaranteed flag)
    InitializeCommonEvent(0,90001033,1049304215,-1,-1,1049304004,1049304915,1049304916,1049304917,1049304918,1049305551,1049305554,1049305559,1049305561,1049300215);
    WaitFixedTimeSeconds(6);
    WarpPlayer(11, 10, 0, 0, 11102021, 0);
});
...
$Event(16002860, Restart, function() {
    ...
    InitializeCommonEvent(0,90001024,1049304156,1049304056,1049304069,-1,1049304852,1049304652,1049304653,1049304654,1049304655,1049304855,1049304857,1049304859,1049304861,1049300156);
    WaitFixedTimeSeconds(6);
    WarpPlayer(11, 10, 0, 0, 11102021, 0);
});
