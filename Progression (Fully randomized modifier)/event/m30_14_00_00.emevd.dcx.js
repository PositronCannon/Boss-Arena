...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 30142800, 0);
    InitializeEvent(0, 30142801, 0);
    InitializeEvent(0, 30142849, 0);
    InitializeEvent(0, 30142811, 0);
    ...
    InitializeCommonEvent(0, 90005250, 30140253, 30142261, 1056964608, 3004);
    InitializeCommonEvent(0, 90005200, 30140269, 30001, 20001, 30142265, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140270, 30001, 20001, 30142265, 1045220557, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140271, 30001, 20001, 30142265, 1056964608, 0, 0, 0, 0);
    ...
    InitializeCommonEvent(0, 90005201, 30140213, 30009, 20009, 1082130432, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005201, 30140214, 30009, 20009, 1082130432, 1045220557, 0, 0, 0, 0);
    ...
    InitializeCommonEvent(0, 90005200, 30140210, 30000, 20000, 30142210, 1077936128, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140211, 30000, 20000, 30142210, 1079194419, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140212, 30000, 20000, 30142210, 1082130432, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140219, 30009, 20009, 30142219, 1065353216, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140220, 30009, 20009, 30142219, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140222, 30009, 20009, 30142219, 1056964608, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005250, 30140219, 30142219, 1065353216, -1);
    InitializeCommonEvent(0, 90005250, 30140220, 30142219, 0, -1);
    InitializeCommonEvent(0, 90005250, 30140222, 30142219, 1056964608, -1);
    ...
    InitializeCommonEvent(0, 90005200, 30140265, 30000, 20000, 30142263, 1050253722, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 30140266, 30000, 20000, 30142263, 1058642330, 0, 0, 0, 0);
    ...
    InitializeEvent(0, 30142510, 0);
    InitializeEvent(0, 30142580, 0);
    InitializeCommonEvent(0, 90005646, 30140800, 30142840, 30142841, 30141840, 30142840, 3614);
    InitializeCommonEvent(0, 91005600, 30142800, 30141695, 5);
});

$Event(50, Default, function() {
    InitializeEvent(0, 30140519, 0);
});
...
$Event(30142520, Restart, function(X0_4, X4_4, X8_4) {
...
$Event(30142800, Restart, function() {
    ...
    InitializeCommonEvent(0,90001023,1049304148,1049304047,-1,-1,1049304753,1049304615,1049304616,1049304617,1049304756,1049304758,1049304760,1049300148);
