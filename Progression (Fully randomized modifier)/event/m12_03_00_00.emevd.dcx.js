...
$Event(0, Default, function() {
    ...
    InitializeCommonEvent(0, 9005810, 12030800, 71230, 12030950, 12031950, 1084227584);
    ...
    //init boss reward
    InitializeEvent(0, 12039990, 0);
});

//siluria
$Event(12039990, Default, function() {
    WaitFor(CharacterDead(12030390));
    //boss rewards (3 bonus items + guaranteed flag)
    InitializeCommonEvent(0,90001033,1049304225,1049304106,1049304114,-1,1049304963,1049304964,1049304965,1049304966,1049305680,1049305683,1049305685,1049305690,1049300225);
});
...
$Event(12032800, Restart, function() {
    ...
    //boss rewards (3 bonus items + guaranteed flag)
    InitializeCommonEvent(0,90001033,1049304209,1049304106,1049304114,-1,1049304891,1049304892,1049304893,1049304894,1049305486,1049305488,1049305491,1049305496,1049300209);
...
L10:
    WaitFor(CharacterHPValue(12030850) <= 0);
    ...
    InitializeCommonEvent(0,90001036,1049304217,1049304004,1049304925,1049304926,1049304927,1049304928,1049304929,1049304930,1049304931,1049305578,1049305581,1049305583,1049305585,1049305589,1049305591,1049305593,1049300217);
    WaitFixedTimeSeconds(6);
    WarpPlayer(11, 10, 0, 0, 11102021, 0);
});
