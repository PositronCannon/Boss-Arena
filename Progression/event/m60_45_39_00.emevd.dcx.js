...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1045390990, 0);
});

//tibia mariner
$Event(1045390990, Default, function() {
    WaitFor(CharacterDead(1045390800));
    //boss rewards (3 bonus items)
    InitializeCommonEvent(0,90001023,1049304120,1049304026,1049304091,-1,1049304499,1049304487,1049304488,1049304489,1049304411,1049304413,1049304416,1049300120);
});
