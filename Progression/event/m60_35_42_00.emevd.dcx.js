...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1035429990, 0);
    InitializeEvent(0, 1035429991, 0);
});

//omenkiller
$Event(1035429990, Default, function() {
    WaitFor(CharacterDead(1035420800));
...
//adula
$Event(1035429991, Default, function() {
    WaitFor(CharacterDead(1034420800));
