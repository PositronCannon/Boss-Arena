...
$Event(0, Default, function() {
    ...
    //init bell bearing hunter
    InitializeEvent(0,1042383990,0);
    //init deathbird
    InitializeEvent(0,1042383991,0);
});

//bell bearing hunter
$Event(1042383990, Default, function() {
    WaitFor(CharacterDead(1042380850));
    //boss rewards (3 bonus items)
    InitializeCommonEvent(0,90001023,1049304116,1049304026,1049304028,-1,1049304362,1049304469,1049304470,1049304471,1049304364,1049304367,1049304372,1049300116);
});

//deathbird
$Event(1042383991, Default, function() {
    WaitFor(CharacterDead(1042380800));
    //boss reward (3 bonus items)
    InitializeCommonEvent(0,90001023,1049304118,1049304028,-1,1049304004,1049304386,1049304477,1049304478,1049304479,1049304388,1049304391,1049304395,1049300118);
});
