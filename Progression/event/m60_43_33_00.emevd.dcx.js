...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1043332990, 0);
});

//erdtree avatar
$Event(1043332990, Default, function() {
    WaitFor(CharacterDead(1043330800));
    //boss rewards (3 bonus items)
    InitializeCommonEvent(0,90001023,1049304124,1049304036,-1,1049304004,1049304452,1049304505,1049304506,1049304507,1049304455,1049304458,1049304463,1049300124);
});
