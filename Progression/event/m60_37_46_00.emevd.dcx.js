...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1037460990, 0);
});

//generic boss event
$Event(1037460990, Default, function() {
    WaitFor(CharacterDead(1037460800));
    //boss rewards (4 bonus items)
    InitializeCommonEvent(0,90001024,1049304158,1049304056,1049304071,-1,1049304875,1049304662,1049304663,1049304664,1049304665,1049304877,1049304880,1049304885,1049304887,1049300158);
});
