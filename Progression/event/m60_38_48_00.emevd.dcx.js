...
$Event(0, Default, function() {
    ...
    //init boss reward
    InitializeEvent(0, 1038482990, 0);
});

//generic boss event
$Event(1038482990, Default, function() {
    WaitFor(CharacterDead(1038480800));
    //boss rewards (4 bonus items)
    InitializeCommonEvent(0,90001024,1049304163,1049304058,-1,-1,1049304936,1049304687,1049304688,1049304689,1049304690,1049304940,1049304943,1049304948,1049304950,1049300163);
});
